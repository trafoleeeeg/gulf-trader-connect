const Footer = () => {
  return (
    <footer className="bg-card border-t border-border py-8 md:py-12" dir="rtl">
      <div className="container mx-auto px-4">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-6 md:mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm md:text-base">
              <li>
                <a href="#start" className="text-muted-foreground hover:text-primary transition-colors">
                  كيف تبدأ
                </a>
              </li>
              <li>
